...
// default number of ticks to add/substract per acceleration or slowing of time. @MINE
constexpr unsigned int DEFAULT_TPS_INCREMENT = DEFAULT_TICKS_PER_SEC * 20 / 100; //@MINE
// default zoom factor
